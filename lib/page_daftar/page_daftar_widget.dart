...
import 'page_daftar_model.dart';
export 'page_daftar_model.dart';

class PageDaftarWidget extends StatefulWidget {
  const PageDaftarWidget({Key? key}) : super(key: key);

  @override
  _PageDaftarWidgetState createState() => _PageDaftarWidgetState();
}

class _PageDaftarWidgetState extends State<PageDaftarWidget> {
  late PageDaftarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageDaftarModel());

    _model.textFieldNamaController ??= TextEditingController();
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: TextFormField(
                  controller: _model.textFieldNamaController,
                  autofocus: true,
                  obscureText: false,
                  ...
                  validator: _model.textFieldNamaControllerValidator
                      .asValidator(context),
                ),
              ),
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    final usersCreateData = createUsersRecordData(
                      displayName: _model.textFieldNamaController.text,
                    );
